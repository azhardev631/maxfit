                            ...
                            <tbody>
                                @foreach ($medical_assessment_questions as $i => $medical_assessment_question)
                                    <tr>
                                        ...
                                        <td>{{ $medical_assessment_question->is_required }}</td>
                                        <td class="d-flex align-items-end justify-content-end vertical-align-middle">

                                            <a href="{{ route('medical-assessment-questions.edit', $medical_assessment_question->id) }}" class="me-2"> <i
                                    ...
                                    <div class="modal fade" id="deleteModal{{ $medical_assessment_question->id }}" tabindex="-1"
                                        role="dialog" aria-labelledby="deleteModalLabel{{ $medical_assessment_question->id }}"
                                        aria-hidden="true">
